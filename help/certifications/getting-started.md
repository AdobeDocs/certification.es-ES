...
| Tipo | Descripción |
| ------- | ------- |
| Examen de certificación | La certificación es una credencial que reconoce la habilidad y competencia de un individuo en una aplicación de Adobe. Un candidato que aprueba el examen de certificación se convierte en un Adobe certificado profesional, experto o máster para el papel de producto y trabajo en el que se basa el examen. |
| Examen de renovación | Las certificaciones de Adobe caducan al cabo de dos años. Al realizar y aprobar un examen de renovación, su credencial de certificación se amplía por otros dos años. |
| Evaluación del curso | Para determinadas soluciones, Adobe ofrece una alternativa a aprobar exámenes de renovación para mantener sus credenciales de certificación. Se ofrecerán a los candidatos (normalmente) de 5 a 7 cursos bajo demanda para su revisión. Cada curso tiene una breve evaluación asociada con ese curso, llamado _evaluación del curso_. El criterio para renovar la certificación es pasar tres evaluaciones cualquiera basadas en los cursos O aprobar dos evaluaciones y enviar un formulario de referencia firmado por el cliente. |
| Prueba de práctica | Una prueba de práctica es una versión completa de un examen de certificación que se basa en el mismo contenido (objetivos de examen) que el examen de certificación. Aunque no son las mismas preguntas que respondes en el examen de certificación, las preguntas sobre la práctica se escriben al mismo tiempo que el examen de certificación. Aunque aprobar una prueba de práctica no puede garantizar que se aprobará el examen de certificación, proporciona un indicador sobresaliente de su preparación para realizar el examen |
...
Adobe [!DNL Experience Cloud] ofrece tres niveles diferentes de certificación: Profesional, Experto y Maestro. Estas certificaciones están diseñadas para validar las habilidades y el conocimiento de los profesionales que trabajan con las soluciones de marketing digital de Adobe.

Estos niveles reflejan una progresión de la competencia y los conocimientos, siendo la certificación profesional la certificación básica, el experto el nivel intermedio y el máster el nivel más alto de certificación.
...
Los exámenes de certificación de Adobe se personalizan en tres funciones de trabajo diferentes. Lea la siguiente información para encontrar la certificación adecuada para su carrera profesional.
...
La Guía de Recorrido de Certificación es una completa herramienta diseñada para proporcionarle toda la información necesaria para prepararse para un examen de certificación. La guía se divide en tres secciones principales: Prepárese, prepárese y obtenga certificación.
...
[!BADGE Obtener certificación]{type=Informative url="https://experienceleague.adobe.com/docs/certification/certification/how-to-get-certified.html?lang=en newtab=true"}
