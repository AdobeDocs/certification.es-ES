...
description: Obtenga información acerca de la certificación  [!DNL Experience Cloud] en Adobe. Descubra lo que puede aportarle obtener la certificación.
role: User,Developer
mini-toc-levels: 1
...
# El programa de certificación de Adobe Digital Experience se ha movido.
...
Visite el sitio web de [Adobe Certified Professional](https://certifiedprofessional.adobe.com/en/home){target="_blank"} para obtener información sobre cómo obtener una certificación en programas de Creative Cloud.
