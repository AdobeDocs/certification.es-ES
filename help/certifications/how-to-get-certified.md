...
**Sigue estos pasos para registrarte en el examen de certificación:**

* **Paso 1:** Inicie sesión correctamente en el [Sistema de administración de credenciales de Adobe](https://www.certmetrics.com/adobe){target="_blank"}.
* **Paso 2:** Vuelva a este sitio y haga clic en Certificaciones técnicas.
* **Paso 3:** Elija su aplicación de Adobe, nivel de certificación y rol
* **Paso 4:** Siga los pasos indicados en la sección **Certificarse**.

**Recursos**

Ejemplo:

* [Cómo registrarte para un examen controlado en línea](https://express.adobe.com/page/Opvo0RlRrlVvr/){target="_blank"}
* [Cómo iniciar el examen y conectarse al procesador](https://express.adobe.com/page/6tQ2pnEDumKY7/){target="_blank"}
* [Requisitos del sistema para realizar pruebas de examinación](https://www.examity.com/test-taker-systems-requirements/){target="_blank"}

>[!TAB Realizando tu examen]

**Su Adobe ID**

Su nombre [profile](https://www.certmetrics.com/adobe/candidate/demographics.aspx){target="_blank"} en el sistema de administración de credenciales de Adobe debe coincidir exactamente con su id. oficial. Si no se tiene información idéntica o si hay alguna discrepancia, el médico cancelará el examen y le exigirá que vuelva a programar su cita además de pagar un cargo adicional por examen.
...
Una vez que complete un examen, recibirá un pase provisional o suspenderá. La puntuación final puede tardar hasta 72 horas en rellenarse. Encontrará su informe de resultados y puntuación en la ficha Historial del [Administrador de credenciales de Adobe](https://www.certmetrics.com/adobe){target="_blank"}.
...
>[!TAB Coste de los exámenes]

**Precios para exámenes de certificación**
...
La mayoría de las renovaciones de certificación son **gratuitas**. Para las certificaciones que no tienen una opción de renovación gratuita, debe volver a realizar el examen de certificación completo para renovar su certificación.
...
Los socios de Bronze y superiores obtienen descuentos en todos los exámenes y clases de certificación de Adobe. Puede obtener más información sobre estos descuentos y cómo acceder a los beneficios de los partners en el [Portal de partners de soluciones](https://solutionpartners.adobe.com/solution-partners/home/learn/credentials/certification/certification_exam_registration_and_management.html?nav=cost){target="_blank"}.
...
* [Guía de procesamiento en línea de Examity](https://www.examity.com/online-proctoring-troubleshooting-guide-for-test-takers-v4/){target="_blank"}
...
* [Cómo programar tu cita para la prueba](https://vimeo.com/394506786){target="_blank"}
...
Las siguientes secciones y vínculos funcionarán solamente después de iniciar sesión correctamente en el [sistema de administración de credenciales de Adobe](https://www.certmetrics.com/adobe){target="_blank"}.

| Vínculos rápidos | Descripción |
| ------- | ------- | 
| Sistema de administración de credenciales de Adobe | [Inicio de sesión en la administración de credenciales de Adobe](https://www.certmetrics.com/adobe){target="_blank"} |
| Perfil | [Página de información demográfica con la ubicación del nombre de la cuenta, la dirección, la compañía, etc. Los nombres solamente se pueden actualizar con un administrador de Adobe ](https://www.certmetrics.com/adobe/candidate/demographics.aspx){target="_blank"}. |
...
| Historial | [Ver informe de puntuación e historial de exámenes](https://www.certmetrics.com/adobe/candidate/cert_summary.aspx){target="_blank"} |
| Certificaciones | [Ver todas sus certificaciones actuales y caducadas](https://www.certmetrics.com/adobe/candidate/cert_summary.aspx){target="_blank"} |

>[!TAB Administrar tus insignias]
...
* **Paso 1:** Inicia sesión en [Credly](https://www.credly.com/users/sign_in){target="_blank"}. _(Debe utilizar el mismo correo electrónico que utilizó para obtener su credencial de Adobe; de lo contrario, no verá su insignia)_
...
* **Paso 2:** Crear una cuenta. _(Debe utilizar el mismo correo electrónico que utilizó para obtener su credencial de Adobe; de lo contrario, no verá su insignia)_
* **Paso 3:** Acepte y comparta su insignia.
