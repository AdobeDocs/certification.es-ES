...
description: Obtenga información sobre cómo obtener la certificación como [!DNL Adobe Analytics] Desarrollador profesional.
solution: Analytics
product: Analytics
role: Developer
...
* Interpretación de un documento de diseño de soluciones (DRS) y comprensión del propósito de todos [!DNL Adobe Analytics] variables recopiladas
* Explicación y trabajo con Adobe (Experience Platform) Launch
* Explicación de la configuración de línea base [!DNL Adobe Analytics] dimensiones y eventos Nombre de página, Nombre de vínculo, Activity Map, etc., pero trabajarán con desarrolladores expertos para más implementaciones de clientes. La asignación de variables sigue siendo propiedad de desarrolladores de nivel experto
...
* Explicación de qué es una capa de datos y cómo leer un objeto JavaScript
...
* Realizar informes básicos desde Analysis Workspace y comprender los resultados de datos disponibles desde [!DNL Adobe Analytics] Data Warehouse
...
* [Guía de administración de Analytics](https://experienceleague.adobe.com/docs/analytics/admin/home.html?lang=es){target="_blank"}
* [Developers Live: Capa de datos del cliente de Adobe: realiza un seguimiento de los datos del visitante](https://experienceleague.adobe.com/docs/adobe-developers-live-events/assets/adobe-client-data-layer.pdf?lang=en){target="_blank"}
